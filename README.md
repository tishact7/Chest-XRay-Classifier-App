...
Alternatively, train your own model using the [classifier training repository]([https://github.com/tishact7/Chest_XRay_Pathology_Classifier]).
...
Full training details and reproducible notebooks are available in the [Chest-XRay-Pathology-Classifier](https://github.com/tishact7/Chest_XRay_Pathology_Classifier) repository.
